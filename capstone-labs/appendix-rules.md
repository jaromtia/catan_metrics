...
This is the subset of rules the engine enforces. See the official Catan rulebook for full details. Use this appendix to derive the constant values in Lab 1 and the validation rules in Lab 2.
